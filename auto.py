...
font = ImageFont.truetype('fonts/Poppins-Medium.ttf', 120) # Setting the font to Poppins Medium and font size to 40
...
def generate(names):
    ...
    for name in names:  
        ...
        name_x, name_y = 1095, 1030 # Setting the co-ordinates to where the names should be entered
